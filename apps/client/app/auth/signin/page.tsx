    ...
    <div className="min-h-screen bg-background grid-bg flex items-center justify-center px-6">
      <div className="w-full max-w-sm animate-fade-up">
        <div className="text-center mb-8">
          ...
          {step === "email" ? (
            <>
              ...
              <p className="text-sm text-dim">Sign in with your email or Google</p>
            </>
          ) : (
            <>
              <h1 className="text-2xl font-semibold text-white tracking-tight mb-2">Check your email</h1>
        ...
        <p className="text-center text-[13px] text-dim mt-6">
          ...
          <Link href="/auth/signup" className="text-emerald hover:text-emerald/80 transition-colors">Create one</Link>
        </p>
      </div>
    </div>
  );
